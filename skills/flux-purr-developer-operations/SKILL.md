...
- Without the paired bypass, every snapshot, credential-store, encryption, durability, or verification failure remains blocking and requires its reported condition to be resolved before a normal flash.
