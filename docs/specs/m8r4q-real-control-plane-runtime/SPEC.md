...
- Web-facing runtime changes must attach fresh visual evidence in this section after the specific Web rollout lands.
- Native daemon and contract-only changes do not require image evidence.
