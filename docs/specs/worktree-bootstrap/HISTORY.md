# Flux Purr Worktree Bootstrap 决策记录

## Legacy identity

- Former legacy ID: `22222`.

## Lifecycle

- `active`: linked-worktree bootstrap and shared hooks remain maintained developer workflow contracts.
