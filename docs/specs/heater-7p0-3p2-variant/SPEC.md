...
- `docs/specs/heater-7p0-3p2-variant/SPEC.md`
...
- `rg -n 'TO''DO|TB''D|待''补充' docs/hardware/heater-plate-design.md docs/hardware/heater-plates/heater-7p0-3p2.md docs/specs/heater-7p0-3p2-variant/SPEC.md`
