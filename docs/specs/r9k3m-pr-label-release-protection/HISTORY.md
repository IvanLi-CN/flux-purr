...
- Release recovery reuses an immutable Release Commit. RC promotion creates a new stable Release Commit; the legacy snapshot-promotion record remains historical only.
