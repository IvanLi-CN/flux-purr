...
- GPIO13 backlight output starts high (off) and remains off through GC9D01 initialization and the startup frame transfer. It is driven low immediately after the startup frame flush succeeds; initialization or startup-flush failures leave the backlight off.
