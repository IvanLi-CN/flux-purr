...
- `docs/specs/s3-fan-cycle-bringup/SPEC.md` 与 `docs/specs/README.md`。
...
- `remotes/origin/th/c3-ch224q-ch442e-frontpanel:docs/specs/s3-ch224q-frontpanel-baseline/SPEC.md`
