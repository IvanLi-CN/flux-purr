...
| - | Firmware update and developer flash | 待实现 | `firmware-update-and-developer-flash/SPEC.md` | - | Signed bundle update, direct local ELF flash, and EEPROM-only persistence boundary |
