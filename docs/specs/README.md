...
|-----:|-------|--------|------|------|-------|
| 233y7 | Flux Purr C3 + CH224Q 前面板基线更新（移除 CH442E，新增 VIN ADC） | 已完成 | `233y7-c3-ch224q-ch442e-frontpanel/SPEC.md` | 2026-03-27 | Baseline updated for VIN ADC sensing and CH442E removal |
