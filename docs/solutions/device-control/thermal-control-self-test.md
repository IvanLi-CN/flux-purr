...
with loss feed-forward, predictive PI, saturation, and conditional anti-windup. `pps3a` remains identifiable but is heater-locked. No point-local thermal profile is a production fallback for either source class.
