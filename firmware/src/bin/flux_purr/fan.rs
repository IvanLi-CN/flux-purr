...
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_PROTOCOL_FAULT_NONE: u8 = 0;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_PROTOCOL_FAULT_VBUS_LOW: u8 = 1;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_PROTOCOL_FAULT_RECEIVED_RESET: u8 = 2;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_PROTOCOL_FAULT_RETRY_FAILED: u8 = 3;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_PROTOCOL_FAULT_PENDING_REQUEST_TIMEOUT: u8 = 4;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_PROTOCOL_FAULT_SOURCE_CAPABILITIES_TIMEOUT: u8 = 5;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_PROTOCOL_FAULT_PARTIAL_RECEIVE_TIMEOUT: u8 = 6;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_PROTOCOL_FAULT_RECEIVE_IO: u8 = 7;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_PROTOCOL_FAULT_TRANSMIT_IO: u8 = 8;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_PROTOCOL_FAULT_CONFIGURATION_IO: u8 = 9;
#[cfg(any(target_arch = "xtensa", test))]
...
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_PROTOCOL_FAULT_RX_FIFO_FLUSH_IO: u8 = 14;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_PROTOCOL_FAULT_RECEIVE_PACKET_IO: u8 = 15;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_PROTOCOL_FAULT_UNSUPPORTED_SOP: u8 = 16;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_I2C_ERROR_NONE: u8 = 0;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_I2C_ERROR_BUS_BUSY: u8 = 1;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_I2C_ERROR_ACK_ADDRESS: u8 = 2;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_I2C_ERROR_ACK_DATA: u8 = 3;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_I2C_ERROR_ACK_UNKNOWN: u8 = 4;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_I2C_ERROR_TIMEOUT: u8 = 5;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_I2C_ERROR_ARBITRATION_LOST: u8 = 6;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_I2C_ERROR_EXECUTION_INCOMPLETE: u8 = 7;
#[cfg(any(target_arch = "xtensa", test))]
...
#[cfg(target_arch = "xtensa")]
pub(crate) const FUSB302B_CONTRACT_REQUEST_TIMEOUT_MS: u64 = 5_000;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) const FUSB302B_PPS_KEEPALIVE_RESPONSE_TIMEOUT_MS: u64 = 1_500;
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) static FUSB302B_DIAGNOSTIC: AtomicU8 = AtomicU8::new(FUSB302B_DIAG_IDLE);
#[cfg(any(target_arch = "xtensa", test))]
pub(crate) static FUSB302B_LAST_PROTOCOL_FAULT: AtomicU8 =
