...
pub const PIN_FAN_PWM: u8 = 6;
pub const PIN_FAN_EN: u8 = 7;

pub const PIN_I2C_SDA: u8 = 8;
pub const PIN_I2C_SCL: u8 = 9;

pub const PIN_KEY_RIGHT: u8 = 10;
...
mod tests {
    ...
    fn gpio_map_accounts_for_s3_direct_frontpanel() {
        ...
        assert_eq!(super::PIN_LCD_BLK, 16);
        assert_eq!(super::PIN_FAN_EN, 7);
