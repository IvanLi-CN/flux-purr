...
## Archived CH224Q material

CH224Q register notes and bring-up records remain in the historical hardware
documentation for traceability only. They are not selected, probed, packaged,
or supported by the production `flux-purr` firmware artifact.
