...
- Buzzer control:
  ...
  - each protection cue retains its four-step pulse rhythm at a fixed `2300Hz` carrier, so neither a pulse nor its one-second replay changes the GPIO48 timer frequency
